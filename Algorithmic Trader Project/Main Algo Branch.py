...
if I can get the stock analyzer, the main algo, then the portfolio analyzer to run in succession over a trading day
and get that for a whole week, then I will know what to work on and how I should fix the algo
"""
