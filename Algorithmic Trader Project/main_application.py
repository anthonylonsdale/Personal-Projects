...
def initial_analysis():
    ...
    # we should consider "anchor points" aka options strikes with high open interest
    max_pain = options_bootstrapper.options_fetch(stock_quote_data)
    print(max_pain)
...
if __name__ == '__main__':
    ...
    try:
        ...
        troublesome_dbs = databaseInitializer().verify_db_integrity()
        if len(troublesome_dbs) > 0:
            ...
            logging.critical("No issues were detected")
